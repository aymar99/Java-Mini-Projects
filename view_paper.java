 ...
 * @author admin
 */
public class view_paper extends javax.swing.JFrame {

    int student_id;
    /**
     * Creates new form view_paper
     */
    public view_paper(int id) {
        student_id=id;
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
                    ...
                    if (id.length()==0 )
                            ...
                            String sql2="select name,domain,conf_date,location,abstract from paper where id=? and student_id=?";
                            ...
                            if(rs.next())
                            {
                                ...
                                JOptionPane.showMessageDialog(null,"paper not found or cannot be viewed");
