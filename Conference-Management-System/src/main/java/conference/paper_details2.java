...
public class paper_details2 extends javax.swing.JFrame {
    ...
    public paper_details2(int id) {
        reviewer_id=id;
        this.setExtendedState(JFrame.MAXIMIZED_BOTH);
        initComponents();
        populate_not_reviewed();
    }
    ...
    private void initComponents() {
        ...
        jButton4.setText("Show Not Reviewed");
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
                ...
                String domain;
                domain=jComboBox1.getSelectedItem().toString();
                String sql="select id,name,domain,reviewed from paper where domain=? ";
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
            populate_not_reviewed();        // TODO add your handling code here:
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        // TODO add your handling code here:
        new view_paper2(reviewer_id).setVisible(true);
        this.dispose();
    ...
    private void populate(){
                String sql="select id,name,domain,reviewed from paper ";
                PreparedStatement pst;
                ResultSet rs ;
                try{
                Class.forName("com.mysql.jdbc.Driver"); 
    ...
    private void populate_not_reviewed(){
                String s="no";
                String u="yes";
                String sql="select id,name,domain,reviewed from paper where selected=? and updated=? ";
                PreparedStatement pst;
                ResultSet rs ;
                try{
                Class.forName("com.mysql.jdbc.Driver"); 
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(paper_details2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
